      ...
      <div class="about-header">
        <div class="header-content">
          <div class="logo-section">
            <div class="about-logo"><img :src="logoUrl" alt="瓜呱" /></div>

            <h2 class="about-title">关于瓜呱</h2>
          </div>
        </div>
      ...
      <div class="about-content">
        <div class="about-main">
          <div class="intro-section">
            <h3>项目简介</h3>
            <p>
              瓜呱图文社区是一个面向开发者与学习者的开源示例项目，旨在提供从前端到后端的完整实践范本，帮助大家学习现代 Web 应用的架构设计、工程化与业务实现。
            </p>
          </div>
          ...
          <div class="api-section">
            ...
            <div class="api-content">
              <p>
                <strong>图片存储：</strong>用户上传的图片默认存储在阿里云 OSS，示例图片使用 <a href="https://picsum.photos/" target="_blank" class="api-link">Picsum</a>。
              </p>
            </div>
          </div>
          ...
          <div class="about-footer">
            <p>&copy; 2026 瓜呱图文社区. Made with ❤️ by @QIUFAN</p>
          </div>
        </div>
      </div>
    </div>
...
const qiufanUrl = new URL('@/assets/imgs/qiufan.png', import.meta.url).href
