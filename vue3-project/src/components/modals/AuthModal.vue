  ...
  try {
    ...
    if (isLoginMode.value) {
      ...
      result = await userStore.register({
        ...
        avatar: new URL('@/assets/imgs/瓜呱.png', import.meta.url).href,
        bio: '用户没有任何简介',
        location: '未知'
      })
    }
