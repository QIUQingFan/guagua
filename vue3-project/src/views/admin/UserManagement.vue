...
const columns = [
  ...
  { key: 'user_id', label: '瓜呱号', type: 'user-link', sortable: false, maxLength: 15 },
...
const formFields = [
  { key: 'user_id', label: '瓜呱号', type: 'text', required: true, placeholder: '请输入瓜呱号', maxlength: 15 },
...
const searchFields = [
  { key: 'user_id', label: '瓜呱号', placeholder: '搜索瓜呱号' },
