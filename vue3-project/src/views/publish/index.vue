    ...
    <div class="publish-content">
      ...
      <form v-if="isLoggedIn" @submit.prevent="handlePublish" class="publish-form">
        ...
        <div class="input-section">
          <input v-model="form.title" type="text" class="title-input" placeholder="请输入标题" maxlength="100" @input="validateForm" />
...
const handlePublish = async () => {
  ...
  try {
    ...
    const postData = {
      ...
      type: uploadType.value === 'image' ? 1 : 2, 
      is_draft: false 
    }
