...
// ========== 电商模块子路由挂载 ==========
// 管理端商品/订单路由，复用本文件的 adminAuth 鉴权 + 仅商家/超管可访问
const adminProductsRoutes = require('./adminProducts')
const adminOrdersRoutes = require('./adminOrders')
router.use('/products', adminAuth, requireRole('super_admin', 'merchant'), adminProductsRoutes)
router.use('/orders', adminAuth, requireRole('super_admin', 'merchant'), adminOrdersRoutes)
